...
if ( $list -> have_posts() ){ ?>
	<div id="<?php echo $widget_id; ?>" class="bwp-countdown <?php echo esc_attr($layout); ?>">       
		...
		<div class="content-product-list">	
			<div class="slider products-list grid slick-carousel" data-dots="<?php echo esc_attr($show_pag);?>" data-slidesToScroll="true" data-nav="<?php echo esc_attr($show_nav);?>" data-columns1440="<?php echo esc_attr($columns1440); ?>" data-columns4="<?php echo $columns4; ?>" data-columns3="<?php echo $columns3; ?>" data-columns2="<?php echo $columns2; ?>" data-columns1="<?php echo $columns1; ?>" data-columns="<?php echo $columns; ?>">	
					...
					<div class="item-product-content products-entry clearfix product-wapper">
						<div class="grid-content">
							...
							<div class="products-content">
								...
								<?php if($show_brands){ digic_get_brans() ;} ?>
								<div class="product-description"><?php echo wp_trim_words( $product->get_short_description(),10 ); ?></div>
						...
						<div class="content-countdown">
							...
							<div class="item-countdown">
								<h2><?php echo esc_html__("Offer end in :","wpbingo") ?></h2>

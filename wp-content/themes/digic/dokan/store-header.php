...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'digic' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'digic' );
                ...
                <div class="profile-info">
                    ...
                    <ul class="dokan-store-info">
                        ...
                        <li class="dokan-store-rating">
                            ...
                            <?php echo wp_kses( dokan_get_readable_seller_rating( $store_user->get_id() ),'social' ); ?>
                        </li>

...
<?php
		 ...
		 * @hooked digic_woocommerce_breadcrumb - 20
		 */
	...
	<div class="contents-detail">
		<div class="main-single-product <?php echo esc_attr($layout_sigle_product); ?>">
			<?php if($layout_sigle_product == 'sidebar' && is_active_sidebar('sidebar-single-product')) { ?>
				<div class="container">
					<div class="row">
						<div class="<?php echo esc_attr(digic_get_class()->class_detail_product_content); ?>">
							<?php while ( have_posts() ) : the_post(); ?>
								<?php wc_get_template_part( 'content', 'single-product' ); ?>
							<?php endwhile; // end of the loop. ?>
						</div>
						<?php if($layout_sigle_product == 'sidebar' && is_active_sidebar('sidebar-single-product')):?>			
							<div class="bwp-sidebar sidebar-single-product <?php echo esc_attr(digic_get_class()->class_sidebar_left); ?>">
